...
export default {
  ...
  mounted() {
    ...
    console.log(this.id);
    let urlpath = "http://127.0.0.1:8001/projectAnalyze/dependency/" + this.id;
    axios
      .get(
        urlpath,
  ...
  methods: {
      ...
      this.graph = new G6.Graph({
        ...
        defaultEdge: {
          ...
          style: {
            ...
            lineAppendWidth: 10,
            endArrow: {
              path: G6.Arrow.triangle(15, 30, 30), // 使用内置箭头路径函数，参数为箭头的 宽度、长度、偏移量（默认为 0，与 d 对应）
              d: 30
            }
          }
        },
    ...
    downloadFile() {
      axios({
        method: "get",
        url: "http://127.0.0.1:8001/projectAnalyze/dependency/export/" + this.id,
        params: {
          userId: this.userId
        },
        responseType: "blob"
